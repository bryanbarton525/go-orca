...
func main() {
	...
	eng := engine.New(store, engine.Options{
		...
		EnableBuilderMode:             cfg.Workflow.EnableBuilderMode,
		EnableAutoMode:                cfg.Workflow.EnableAutoMode,
		AutoModeMaxDefinitionAttempts: cfg.Workflow.AutoModeMaxDefinitionAttempts,
